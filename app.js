...
mm.add("(min-width: 768px)", ()=>{
    ...
    servicesSlide.forEach((slide, i) =>{
        const servicesSlideTimeline = gsap.timeline({
            scrollTrigger:{
                ...
                scrub: true,
                start: ()=> "-200 -" + (window.innerHeight*i),
                end: ()=> "+=" + window.innerHeight
            }
        }).from(slide, {x: -200, opacity: 0, stagger: 2})
        .to(".automation", {x: -200, opacity: 0}, "<+1")
    ...
    diagramaSlide.forEach((diagrama, i) =>{
        ...
        }).from(diagrama, {y: 200, opacity: 0, stagger: 2})
        .to(".coroleu", {y: -200, opacity: 0}, "<+1")
    ...
    ScrollTrigger.create({
        ...
        // pinSpacer: true
        // end: () => "+=" + ((slide.length + 1) * window.innerHeight),
    })
})
...
mm.add("(max-width: 768px)", ()=>{
    ...
    servicesSlide.forEach((slide, i) =>{
        ...
        }).from(slide, {scale: 0, opacity: 0, stagger: 2})
    ...
    diagramaSlide.forEach((diagrama, i) =>{
        ...
        }).from(diagrama, {scale: 0, opacity: 0, stagger: 2})
